...
export declare type RecordMode = 'live' | 'playback' | 'external';
export declare type Record = Map<RecordMode, TrackerInterface>;
export declare type LoopCallback = (frames: number) => void;
...
export declare type BoundsType = 'basic' | 'uptempo' | 'ballade' | 'rating';
