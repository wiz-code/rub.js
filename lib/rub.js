...
var PointerHandler = /*#__PURE__*/function () {
  function PointerHandler(els) {
    ...
    this.coords = new _tracker__WEBPACK_IMPORTED_MODULE_6__.default(TRACK_SIZE, BLOCK_SIZE);
    this.listener = {};
  }
...
var Recorder = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Recorder, [{
    ...
    value: function createRecord() {
      var tracker = new _tracker__WEBPACK_IMPORTED_MODULE_7__.default(TRACK_SIZE, this.blockSize);
      tracker.writeFrames();
      return tracker;
    }
  }, {
