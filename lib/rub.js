...
var Recorder = /*#__PURE__*/function () {
  ...
  function Recorder(els) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "recordModeSet", new (_babel_runtime_corejs3_core_js_set__WEBPACK_IMPORTED_MODULE_4___default())(['live', 'playback-1', 'playback-2', 'external-1', 'external-2']));
...
var Rub = /*#__PURE__*/function () {
  function Rub(container, callback) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "zoneId", void 0);
    ...
    for (var i = 0, l = zones.length; i < l; i += 1) {
      var _zone = zones[i];
      var zoneId = _zone.dataset.zoneId;
    ...
    var zone = this.area.get(this.zoneId);
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(Rub, [{
    ...
    value: function output() {
      var _ref = this.area.get(this.zoneId),
    ...
    value: function input(ctime) {
      ...
      var _ref2 = this.area.get(this.zoneId),
          event = _ref2.event,
    ...
    value: function stopLoop() {
      var _ref3 = this.area.get(this.zoneId),
    ...
    key: "getCurrentFramerate",
    value: function getCurrentFramerate() {
      return this.framerate;
    }
  }, {
    key: "getCurrentZoneId",
    value: function getCurrentZoneId() {
      return this.zoneId;
    }
  }, {
    key: "getRecorder",
    value: function getRecorder() {
      return this.area.get(this.zoneId).recorder;
    }
  }, {
    key: "setZone",
    ...
    value: function setEventHandler() {
      var _ref4 = this.area.get(this.zoneId),
          event = _ref4.event;
    ...
    value: function removeEventHandler() {
      var _ref5 = this.area.get(this.zoneId),
          event = _ref5.event;
    ...
    value: function resetZone() {
      var _ref6 = this.area.get(this.zoneId),
          event = _ref6.event,
