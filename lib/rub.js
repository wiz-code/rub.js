...
var Rub = /*#__PURE__*/function () {
  function Rub(container, callback) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "input", void 0);

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "output", void 0);
    ...
    this.output = function () {
      var _this$getCurrentZone = _this.getCurrentZone(),
          recorder = _this$getCurrentZone.recorder;

      if (_this.loopCallbacks.length > 0) {
        var _frames = recorder.getFrames();

        for (var _i = 0, _l = _this.loopCallbacks.length; _i < _l; _i += 1) {
          _this.loopCallbacks[_i](_frames);
        }
      }
    ...
    this.input = function (ctime) {
      var _this$getCurrentZone2 = _this.getCurrentZone(),
