...
var Recorder = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Recorder, [{
    ...
    value: function getVelocity() {
      ...
      var velocities = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_6___default()(track.subarray(1));
    ...
    key: "setShiftedFrames",
    value: function setShiftedFrames(frames) {
      var mode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'live';
...
/* harmony import */ var _pointer_handler__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./pointer-handler */ "./src/modules/pointer-handler.ts");
/* harmony import */ var _event_type__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./event-type */ "./src/modules/event-type.ts");
...
var TouchHandler = /*#__PURE__*/function (_PointerHandler) {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(TouchHandler, [{
    ...
    value: function addListeners(el) {
      ...
      this.attached = true;
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchStart, this.listener.start, false);
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchMove, this.listener.move, false);
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchEnd, this.listener.end, false);
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchCancel, this.listener.end, false);
    }
  }, {
    key: "removeListeners",
    value: function removeListeners(el) {
      ...
      this.attached = false;
      el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchStart, this.listener.start, false);
      el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchMove, this.listener.move, false);
      el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchEnd, this.listener.end, false);
      el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchCancel, this.listener.end, false);
    }
  }], [{
    key: "start",
    value: function start(state, event) {
      ...
      var touch = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_7___default()(event.changedTouches)[0];
  ...
  return TouchHandler;
}(_pointer_handler__WEBPACK_IMPORTED_MODULE_8__.default);
...
/* harmony import */ var _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/array/from */ "./node_modules/@babel/runtime-corejs3/core-js/array/from.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _babel_runtime_corejs3_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/object/keys */ "./node_modules/@babel/runtime-corejs3/core-js/object/keys.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _babel_runtime_corejs3_core_js_object_assign__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/object/assign */ "./node_modules/@babel/runtime-corejs3/core-js/object/assign.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_object_assign__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_object_assign__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var javascript_state_machine__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! javascript-state-machine */ "./node_modules/javascript-state-machine/state-machine.js");
/* harmony import */ var javascript_state_machine__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(javascript_state_machine__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _modules_mouse_handler__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/mouse-handler */ "./src/modules/mouse-handler.ts");
/* harmony import */ var _modules_touch_handler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/touch-handler */ "./src/modules/touch-handler.ts");
/* harmony import */ var _modules_recorder__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/recorder */ "./src/modules/recorder.ts");
/* harmony import */ var _modules_dataset__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/dataset */ "./src/modules/dataset.ts");
...
var Rub = /*#__PURE__*/function () {
  function Rub(container, callback) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "region", {});

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "currentZoneType", void 0);
    ...
    var zones = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_4___default()(regionContainer.children);
    ...
    for (var i = 0, l = zones.length; i < l; i += 1) {
      ...
      var targetEls = _zone.childElementCount > 0 ? _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_4___default()(_zone.children) : [_zone];
      var Handler = !isTouchEnabled() ? _modules_mouse_handler__WEBPACK_IMPORTED_MODULE_8__.default : _modules_touch_handler__WEBPACK_IMPORTED_MODULE_9__.default;
      this.region[zoneType] = {
        recorder: new _modules_recorder__WEBPACK_IMPORTED_MODULE_10__.default(targetEls),
        event: new Handler(targetEls)
      };
    }

    var _ref = _babel_runtime_corejs3_core_js_object_keys__WEBPACK_IMPORTED_MODULE_5___default()(this.region),
        _ref2 = (0,_babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_ref, 1),
        key = _ref2[0];

    var zone = this.region[key];
    this.currentZoneType = key;
    zone.event.addListeners(this.container);
    this.media = javascript_state_machine__WEBPACK_IMPORTED_MODULE_7___default().create(_modules_dataset__WEBPACK_IMPORTED_MODULE_11__.default.media);
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(Rub, [{
    ...
    value: function output() {
      var _this$getCurrentZone = this.getCurrentZone(),
          recorder = _this$getCurrentZone.recorder;
    ...
    value: function input(ctime) {
      var _this$getCurrentZone2 = this.getCurrentZone(),
          event = _this$getCurrentZone2.event,
          recorder = _this$getCurrentZone2.recorder;
      ...
      if (event.isAttached()) {
        ...
        if (count > this.offset) {
          ...
          var _Array$from2 = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_4___default()(track),
    ...
    value: function stopLoop() {
      var _this$getCurrentZone3 = this.getCurrentZone(),
          recorder = _this$getCurrentZone3.recorder;
    ...
    key: "getCurrentZoneType",
    value: function getCurrentZoneType() {
      return this.currentZoneType;
    }
  }, {
    key: "getCurrentZone",
    value: function getCurrentZone() {
      return this.region[this.currentZoneType];
    }
  }, {
    key: "setZone",
    ...
    value: function setMediaCallback(callback) {
      _babel_runtime_corejs3_core_js_object_assign__WEBPACK_IMPORTED_MODULE_6___default()(this.media, callback);
    }
  }, {
    key: "addLoopCallback",
    ...
    key: "clearLoopCallback",
    value: function clearLoopCallback() {
      this.loopCallbacks.length = 0;
    }
  }, {
    key: "setEventHandler",
    value: function setEventHandler() {
      var _this$getCurrentZone4 = this.getCurrentZone(),
          event = _this$getCurrentZone4.event;
    ...
    value: function removeEventHandler() {
      var _this$getCurrentZone5 = this.getCurrentZone(),
          event = _this$getCurrentZone5.event;
    ...
    value: function resetZone() {
      var _this$getCurrentZone6 = this.getCurrentZone(),
          event = _this$getCurrentZone6.event,
          recorder = _this$getCurrentZone6.recorder;
    ...
    value: function getVelocity() {
      ...
      var _this$getCurrentZone7 = this.getCurrentZone(),
          recorder = _this$getCurrentZone7.recorder;
    ...
    value: function shiftFrames(frames) {
      ...
      var _this$getCurrentZone8 = this.getCurrentZone(),
          recorder = _this$getCurrentZone8.recorder;
    ...
    key: "getFrames",
    value: function getFrames() {
      var _this$getCurrentZone9 = this.getCurrentZone(),
          recorder = _this$getCurrentZone9.recorder;
    ...
    key: "setFrames",
    value: function setFrames(frames) {
      var _this$getCurrentZone10 = this.getCurrentZone(),
          recorder = _this$getCurrentZone10.recorder;
