...
/***/ "./src/modules/pointer-handler.rc.ts":
/*!*******************************************!*\
  !*** ./src/modules/pointer-handler.rc.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var Recorder = /*#__PURE__*/function () {
  ...
  function Recorder(els) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "recordModeSet", new (_babel_runtime_corejs3_core_js_set__WEBPACK_IMPORTED_MODULE_4___default())(['live', 'playback-1', 'playback-2']));

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "recordModes", new (_babel_runtime_corejs3_core_js_set__WEBPACK_IMPORTED_MODULE_4___default())(['live']));
    ...
    this.targetNum = els.length; // this.blockSize = targetNum + 1;

    this.recordModeSet.forEach(function (mode) {
      _this.records.set(mode, _this.createRecord());

      _this.shiftedFrames.set(mode, 0);
    }); // this.template = Array(targetNum + 1).fill(0);

    this.template = _babel_runtime_corejs3_core_js_instance_fill__WEBPACK_IMPORTED_MODULE_5___default()(_context = Array(this.targetNum)).call(_context, 0);
  }
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Recorder, [{
    ...
    value: function createRecord() {
      ...
      var trackSize = duration * FPS; // const tracker = new Tracker(trackSize, this.blockSize);

      var tracker = new _tracker__WEBPACK_IMPORTED_MODULE_8__.default(trackSize, this.targetNum); // tracker.writeFrames();
    ...
    value: function destroy() {
      ...
      this.recordModeSet.forEach(function (mode) {
        _this2.records.set(mode, new _tracker__WEBPACK_IMPORTED_MODULE_8__.default(0, 0));
      });
    }
  }, {
    key: "isRecordable",
    ...
    key: "setRecordModes",
    value: function setRecordModes(modes) {
      this.recordModes = new (_babel_runtime_corejs3_core_js_set__WEBPACK_IMPORTED_MODULE_4___default())(modes);
    }
    ...
    value: function setFrames(frames) {
      ...
      var track = _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_6___default()(_context3 = this.template).call(_context3, 0); // track[0] = frames;


      this.records.get('live').setTrack(track, frames);
    ...
    value: function resizeRecord(duration) {
      ...
      this.recordModeSet.forEach(function (mode) {
        _this3.records.set(mode, _this3.createRecord(duration));
      });
      this.resetFrames();
    }
  }, {
    ...
    value: function getVelocity(offset) {
      ...
      this.recordModes.forEach(function (mode) {
        var shifted = offset + _this4.shiftedFrames.get(mode);

        var track = _this4.records.get(mode).getTrack(shifted);

        var velocity = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_7___default()(track.subarray(0));
    ...
    value: function setRecord(tracks) {
      ...
      this.records.get(mode).setTrack(tracks);
    }
  }, {
    key: "addData",
    ...
    value: function getRecentBlockData() {
      ...
      this.recordModes.forEach(function (mode) {
        ...
        var tracker = _this5.records.get(mode);

        if (start < 0) {
          var _context4;

          var track = _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_6___default()(_context4 = _this5.template).call(_context4, 0);
...
var Tracker = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Tracker, [{
    ...
    value: function getLastTrack() {
      ...
      position %= length;
      var track = this.tracks.subarray(position, this.end);
      return track;
    }
  }, {
    key: "getTrack",
...
/* harmony import */ var _modules_pointer_handler_rc__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/pointer-handler.rc */ "./src/modules/pointer-handler.rc.ts");
...
var Rub = /*#__PURE__*/function () {
  function Rub(container, callback) {
    ...
    this.id = genId();
    var areaContainer = this.container.querySelector(".".concat(AREA_ID));

    var zones = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_5___default()(areaContainer.children);
    ...
    for (var i = 0, l = zones.length; i < l; i += 1) {
      ...
      this.area.set(trackingZone, {
        ...
        event: new _modules_pointer_handler_rc__WEBPACK_IMPORTED_MODULE_9__.default(targetEls)
      });
    }
    ...
    this.media = javascript_state_machine__WEBPACK_IMPORTED_MODULE_8___default().create(_modules_dataset__WEBPACK_IMPORTED_MODULE_11__.default.media);
