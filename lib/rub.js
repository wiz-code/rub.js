...
/* harmony import */ var _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/instance/slice */ "./node_modules/@babel/runtime-corejs3/core-js/instance/slice.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/array/from */ "./node_modules/@babel/runtime-corejs3/core-js/array/from.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_6__);
...
var Recorder = /*#__PURE__*/function () {
  function Recorder(els) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "record", void 0);
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "shiftedFrames", void 0);
    ...
    this.record = new (_babel_runtime_corejs3_core_js_map__WEBPACK_IMPORTED_MODULE_3___default())([['live', this.createRecord()], ['playback', this.createRecord()], ['external', this.createRecord()]]);
    this.shiftedFrames = new (_babel_runtime_corejs3_core_js_map__WEBPACK_IMPORTED_MODULE_3___default())([['live', 0], ['playback', 0], ['external', 0]]);
    this.template = _babel_runtime_corejs3_core_js_instance_fill__WEBPACK_IMPORTED_MODULE_4___default()(_context = Array(targetNum + 1)).call(_context, 0);
  }
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Recorder, [{
    ...
    value: function update(ctime, velocity, targetIndex) {
      ...
      var track = _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_5___default()(_context2 = this.template).call(_context2, 0);
    ...
    value: function createRecord() {
      ...
      var trackSize = duration * 60;
      var tracker = new _tracker__WEBPACK_IMPORTED_MODULE_7__.default(trackSize, this.blockSize);
      tracker.writeFrames();
      return tracker;
    }
  }, {
    key: "destroy",
    value: function destroy() {
      this.record = new (_babel_runtime_corejs3_core_js_map__WEBPACK_IMPORTED_MODULE_3___default())([['live', new _tracker__WEBPACK_IMPORTED_MODULE_7__.default(0, 0)], ['playback', new _tracker__WEBPACK_IMPORTED_MODULE_7__.default(0, 0)], ['external', new _tracker__WEBPACK_IMPORTED_MODULE_7__.default(0, 0)]]);
    }
  }, {
    key: "getBlockSize",
    ...
    value: function setFrames(frames) {
      ...
      var track = _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_5___default()(_context3 = this.template).call(_context3, 0);
    ...
    value: function resizeRecord(duration) {
      this.record = new (_babel_runtime_corejs3_core_js_map__WEBPACK_IMPORTED_MODULE_3___default())([['live', this.createRecord(duration)], ['playback', this.createRecord(duration)], ['external', this.createRecord(duration)]]);
      this.resetFrames();
    }
  }, {
    key: "clearRecord",
    ...
    value: function getVelocity() {
      ...
      var shifted = offset < 0 ? offset : offset + this.shiftedFrames.get(mode);
      var track = this.record.get(mode).getTrack(shifted);

      var velocity = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_6___default()(track.subarray(1));
    ...
    value: function getRecentBlockData() {
      ...
      var start = offset - (count - 1) + this.shiftedFrames.get(mode);

      if (start < 0) {
        return [this.record.get(mode).getTrack(0, 1)];
      }

      var tracks = this.record.get(mode).getTrack(start, count);
      var blockData = [];

      for (var i = 0, l = tracks.length; i < l; i += this.blockSize) {
        blockData.push(_babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_5___default()(tracks).call(tracks, i, i + this.blockSize));
      }
