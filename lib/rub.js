...
/* harmony import */ var _modules_mouse_handler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/mouse-handler */ "./src/modules/mouse-handler.ts");
/* harmony import */ var _modules_touch_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/touch-handler */ "./src/modules/touch-handler.ts");
/* harmony import */ var _modules_recorder__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/recorder */ "./src/modules/recorder.ts");
/* harmony import */ var _modules_dataset__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/dataset */ "./src/modules/dataset.ts");
...
class Rub {
    constructor(container, callback) {
        ...
        for (let i = 0, l = els.length; i < l; i += 1) {
            ...
            const Handler = !isTouchEnabled() ? _modules_mouse_handler__WEBPACK_IMPORTED_MODULE_1__.default : _modules_touch_handler__WEBPACK_IMPORTED_MODULE_2__.default;
            this.bounds.set(identifier, {
                recorder: new _modules_recorder__WEBPACK_IMPORTED_MODULE_3__.default(targetEls),
        ...
        this.media = javascript_state_machine__WEBPACK_IMPORTED_MODULE_0___default().create(_modules_dataset__WEBPACK_IMPORTED_MODULE_4__.default.media);
        if (callback != null) {
