...
/* harmony import */ var _babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime-corejs3/helpers/assertThisInitialized */ "./node_modules/@babel/runtime-corejs3/helpers/esm/assertThisInitialized.js");
...
/* harmony import */ var _pointer_handler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./pointer-handler */ "./src/modules/pointer-handler.ts");
...
var MouseHandler = /*#__PURE__*/function (_PointerHandler) {
  (0,_babel_runtime_corejs3_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__.default)(MouseHandler, _PointerHandler);
  ...
  function MouseHandler(els) {
    ...
    (0,_babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__.default)(this, MouseHandler);

    _this = _super.call(this, els);
    _this.listener = {
      start: MouseHandler.start.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this), _this.state),
      end: MouseHandler.end.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this), _this.state),
      move: MouseHandler.move.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this), _this.state),
      activate: MouseHandler.activate.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this)),
      inactivate: MouseHandler.inactivate.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this))
    };
    return _this;
  }

  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(MouseHandler, [{
    key: "addListeners",
    value: function addListeners(el) {
      ...
      this.attached = true;
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseDown, this.listener.start, false);
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseMove, this.listener.move, false);
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseUp, this.listener.end, false);

      for (var i = 0, l = this.targets.length; i < l; i += 1) {
        var target = this.targets[i];
        target.el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseEnter, this.listener.activate, false);
        target.el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseLeave, this.listener.inactivate, false);
      }
    }
  }, {
    key: "removeListeners",
    value: function removeListeners(el) {
      ...
      this.attached = false;
      el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseDown, this.listener.start, false);
      el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseMove, this.listener.move, false);
      el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseUp, this.listener.end, false);

      for (var i = 0, l = this.targets.length; i < l; i += 1) {
        var target = this.targets[i];
        target.el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseEnter, this.listener.activate, false);
        target.el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.MouseLeave, this.listener.inactivate, false);
      }
    }
  }], [{
    key: "start",
  ...
  return MouseHandler;
}(_pointer_handler__WEBPACK_IMPORTED_MODULE_7__.default);
...
/* harmony import */ var _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/array/from */ "./node_modules/@babel/runtime-corejs3/core-js/array/from.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _tracker__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./tracker */ "./src/modules/tracker.ts");
...
var Recorder = /*#__PURE__*/function () {
  function Recorder(els) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "record", new (_babel_runtime_corejs3_core_js_map__WEBPACK_IMPORTED_MODULE_3___default())());

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "blockSize", void 0);

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "recordModes", new (_babel_runtime_corejs3_core_js_set__WEBPACK_IMPORTED_MODULE_4___default())(['live', 'playback', 'external']));
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__.default)(this, "mergeMode", false);
    ...
    this.recordModes.forEach(function (mode) {
      _this.record.set(mode, _this.createRecord());

      _this.shiftedFrames.set(mode, 0);
    });
    this.template = _babel_runtime_corejs3_core_js_instance_fill__WEBPACK_IMPORTED_MODULE_5___default()(_context = Array(targetNum + 1)).call(_context, 0);
  }
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Recorder, [{
    ...
    value: function update(ctime, velocity, targetIndex) {
      ...
      var liveTracker = this.record.get('live'); // 開始時点のフレームには何も書き込まない
      ...
      if (!this.started) {
        ...
        if (currentFrames > this.frames) {
          ...
          if (targetIndex > -1) {
            ...
            if (this.mergeMode) {
              if (velocity === 0) {
                var oldTrack = liveTracker.getTrack(this.frames);
    ...
    value: function createRecord() {
      ...
      var trackSize = duration * 60;
      var tracker = new _tracker__WEBPACK_IMPORTED_MODULE_8__.default(trackSize, this.blockSize);
      tracker.writeFrames();
      return tracker;
    }
  }, {
    ...
    value: function destroy() {
      ...
      this.recordModes.forEach(function (mode) {
        _this2.record.set(mode, new _tracker__WEBPACK_IMPORTED_MODULE_8__.default(0, 0));
      });
    }
  }, {
    key: "isRecordable",
    ...
    value: function resizeRecord(duration) {
      ...
      this.recordModes.forEach(function (mode) {
        _this3.record.set(mode, _this3.createRecord(duration));
      });
      this.resetFrames();
    }
  }, {
    ...
    value: function getVelocity() {
      ...
      this.recordModes.forEach(function (mode) {
        var shifted = offset < 0 ? offset : offset + _this4.shiftedFrames.get(mode);

        var track = _this4.record.get(mode).getTrack(shifted);

        var velocity = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_7___default()(track.subarray(1));
    ...
    value: function getRecentBlockData() {
      ...
      var map = new (_babel_runtime_corejs3_core_js_map__WEBPACK_IMPORTED_MODULE_3___default())();
      this.recordModes.forEach(function (mode) {
        var start = offset + _this5.shiftedFrames.get(mode) - (count - 1);

        var tracker = _this5.record.get(mode);
...
/***/ "./src/modules/touch-handler.rc.ts":
/*!*****************************************!*\
  !*** ./src/modules/touch-handler.rc.ts ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var TouchHandler = /*#__PURE__*/function (_PointerHandler) {
  (0,_babel_runtime_corejs3_helpers_inherits__WEBPACK_IMPORTED_MODULE_4__.default)(TouchHandler, _PointerHandler);
  ...
  function TouchHandler(els) {
    ...
    (0,_babel_runtime_corejs3_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1__.default)(this, TouchHandler);

    _this = _super.call(this, els);
    _this.listener = {
      start: TouchHandler.start.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this), _this.state),
      move: TouchHandler.move.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this), _this.state),
      end: TouchHandler.end.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this), _this.state),
      activate: TouchHandler.activate.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this)),
      inactivate: TouchHandler.inactivate.bind((0,_babel_runtime_corejs3_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_3__.default)(_this))
    };
    return _this;
  }

  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(TouchHandler, [{
    key: "addListeners",
    value: function addListeners(el) {
      if (this.listener == null) {
        return;
      ...
      for (var i = 0, l = this.targets.length; i < l; i += 1) {
        var target = this.targets[i];
        target.el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.PointerEnter, this.listener.activate, false);
        target.el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.PointerLeave, this.listener.inactivate, false);
      }
    }
  }, {
    key: "removeListeners",
    value: function removeListeners(el) {
      ...
      for (var i = 0, l = this.targets.length; i < l; i += 1) {
        var target = this.targets[i];
        target.el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.PointerEnter, this.listener.activate, false);
        target.el.removeEventListener(_event_type__WEBPACK_IMPORTED_MODULE_8__.default.PointerLeave, this.listener.inactivate, false);
      }
    }
  }], [{
    key: "start",
...
/* harmony import */ var _babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime-corejs3/helpers/createClass */ "./node_modules/@babel/runtime-corejs3/helpers/esm/createClass.js");
/* harmony import */ var _babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime-corejs3/helpers/defineProperty */ "./node_modules/@babel/runtime-corejs3/helpers/esm/defineProperty.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_instance_fill__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime-corejs3/core-js/instance/fill */ "./node_modules/@babel/runtime-corejs3/core-js/instance/fill.js");
/* harmony import */ var _babel_runtime_corejs3_core_js_instance_fill__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_corejs3_core_js_instance_fill__WEBPACK_IMPORTED_MODULE_3__);
...
var Tracker = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Tracker, [{
    ...
    value: function getTrack() {
      ...
      var count = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
      var length = this.tracks.length;
      var position = offset < 0 ? (this.count + offset) * this.blockSize : offset * this.blockSize;
      position %= length;
    ...
    value: function clearTracks() {
      ...
      _babel_runtime_corejs3_core_js_instance_fill__WEBPACK_IMPORTED_MODULE_3___default()(_context = this.tracks).call(_context, 0);
    }
  }, {
    key: "writeFrames",
    value: function writeFrames() {
      this.clearTracks();
...
/* harmony import */ var _modules_mouse_handler__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/mouse-handler */ "./src/modules/mouse-handler.ts");
/* harmony import */ var _modules_touch_handler_rc__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/touch-handler.rc */ "./src/modules/touch-handler.rc.ts");
...
var Rub = /*#__PURE__*/function () {
  function Rub(container, callback) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "region", new (_babel_runtime_corejs3_core_js_map__WEBPACK_IMPORTED_MODULE_4___default())());

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "zoneName", void 0);
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "multiplier", detectDevicePixelRatio());

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "media", void 0);

    this.id = genId();
    var regionContainer = this.container.querySelector(".".concat(REGION_ID));

    var zones = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_5___default()(regionContainer.children);

    for (var i = 0, l = zones.length; i < l; i += 1) {
      var _zone = zones[i];
      var zoneName = _zone.dataset.zoneName;
      ...
      var Handler = !isTouchEnabled() ? _modules_mouse_handler__WEBPACK_IMPORTED_MODULE_9__.default : _modules_touch_handler_rc__WEBPACK_IMPORTED_MODULE_10__.default;
    ...
    var keys = _babel_runtime_corejs3_core_js_instance_keys__WEBPACK_IMPORTED_MODULE_6___default()(_context = this.region).call(_context);

    this.zoneName = keys.next().value;
    var zone = this.region.get(this.zoneName);
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(Rub, [{
    ...
    value: function output() {
      var _ref = this.region.get(this.zoneName),
    ...
    value: function input(ctime) {
      var _ref2 = this.region.get(this.zoneName),
          event = _ref2.event,
    ...
    value: function stopLoop() {
      var _ref3 = this.region.get(this.zoneName),
    ...
    key: "getCurrentZoneName",
    value: function getCurrentZoneName() {
      return this.zoneName;
    }
  }, {
    key: "getRecorder",
    value: function getRecorder() {
      return this.region.get(this.zoneName).recorder;
    }
  }, {
    key: "setZone",
    value: function setZone(key) {
      var zone = this.region.get(key);
    ...
    value: function destroy() {
      ...
      this.region.forEach(function (zone) {
        zone.event.destroy();
    ...
    value: function setDuration(duration) {
      var _ref4 = this.region.get(this.zoneName),
          recorder = _ref4.recorder;
    ...
    value: function setEventHandler() {
      var _ref5 = this.region.get(this.zoneName),
          event = _ref5.event;
    ...
    value: function removeEventHandler() {
      var _ref6 = this.region.get(this.zoneName),
          event = _ref6.event;
    ...
    key: "resetZone",
    value: function resetZone() {
      var _ref7 = this.region.get(this.zoneName),
          event = _ref7.event,
          recorder = _ref7.recorder;
