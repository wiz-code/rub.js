...
var Recorder = /*#__PURE__*/function () {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Recorder, [{
    ...
    value: function createRecord() {
      ...
      var tracker = new _tracker__WEBPACK_IMPORTED_MODULE_8__.default(trackSize, this.targetNum);
      return tracker;
    }
  }, {
    key: "destroy",
    ...
    value: function getVelocity(offset) {
      ...
      this.recordModes.forEach(function (mode) {
        ...
        if (track.length === 0) {
          ...
          velocity = _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_6___default()(_context4 = _this2.template).call(_context4, 0);
        } else {
          velocity = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_7___default()(track.subarray(0));
        }
