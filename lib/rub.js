...
var Rub = /*#__PURE__*/function () {
  function Rub(container, callback) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "bounds", new (_babel_runtime_corejs3_core_js_map__WEBPACK_IMPORTED_MODULE_4___default())());

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "currentBoundsType", void 0);
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "event", void 0);

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "recorder", void 0);

    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "media", void 0);

    this.id = genId();
    var boundsContainer = this.container.querySelector(".".concat(BOUNDS_ID));

    var els = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_5___default()(boundsContainer.children);
    ...
    for (var i = 0, l = els.length; i < l; i += 1) {
      ...
      var targetEls = el.childElementCount > 0 ? _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_5___default()(el.children) : [el];
    ...
    var _Array$from2 = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_5___default()(_babel_runtime_corejs3_core_js_instance_keys__WEBPACK_IMPORTED_MODULE_6___default()(_context = this.bounds).call(_context)),
        _Array$from3 = (0,_babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_Array$from2, 1),
        key = _Array$from3[0];
    ...
    this.output = function () {
      if (_this.loopCallbacks.length > 0) {
        var _frames = _this.recorder.getFrames();
    ...
    this.input = function (ctime) {
      ...
      if (_this.event.isAttached()) {
        ...
        if (count > _this.offset) {
          ...
          var _Array$from4 = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_5___default()(track),
              _Array$from5 = (0,_babel_runtime_corejs3_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__.default)(_Array$from4, 3),
              t = _Array$from5[0],
              x = _Array$from5[1],
              y = _Array$from5[2];
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(Rub, [{
    ...
    key: "getCurrentBoundsType",
    value: function getCurrentBoundsType() {
      return this.currentBoundsType;
    }
  }, {
    key: "setBoundsType",
    value: function setBoundsType(key) {
      var bounds = this.bounds.get(key);
    ...
    key: "resetBoundsType",
    value: function resetBoundsType() {
