...
var TouchHandler = /*#__PURE__*/function (_PointerHandler) {
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(TouchHandler, [{
    ...
    value: function addListeners(el) {
      ...
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchStart, this.listener.start, eventOptions);
      el.addEventListener(_event_type__WEBPACK_IMPORTED_MODULE_9__.default.TouchMove, this.listener.move, eventOptions);
...
var Rub = /*#__PURE__*/function () {
  function Rub(container, callback) {
    ...
    for (var i = 0, l = zones.length; i < l; i += 1) {
      ...
      var Handler = !isTouchEnabled() ? _modules_mouse_handler__WEBPACK_IMPORTED_MODULE_9__.default : _modules_touch_handler__WEBPACK_IMPORTED_MODULE_10__.default;
