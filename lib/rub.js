...
var Recorder = /*#__PURE__*/function () {
  function Recorder(els) {
    ...
    this.template = _babel_runtime_corejs3_core_js_instance_fill__WEBPACK_IMPORTED_MODULE_3___default()(_context = Array(targetNum + 1)).call(_context, 0);
  }
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__.default)(Recorder, [{
    ...
    value: function update(ctime, velocity, targetIndex) {
      ...
      var track = _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_4___default()(_context2 = this.template).call(_context2, 0);

      var liveTracker = this.record.live;
    ...
    value: function createRecord() {
      var tracker = new _tracker__WEBPACK_IMPORTED_MODULE_6__.default(TRACK_SIZE, this.blockSize);
      tracker.writeFrames();
      return tracker;
    }
  }, {
    ...
    value: function setFrames(frames) {
      ...
      var track = _babel_runtime_corejs3_core_js_instance_slice__WEBPACK_IMPORTED_MODULE_4___default()(_context3 = this.template).call(_context3, 0);
    ...
    value: function getVelocity() {
      ...
      var track = this.record[mode].getTrack(shifted);

      var velocities = _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_5___default()(track.subarray(1));
...
var Rub = /*#__PURE__*/function () {
  function Rub(container, callback) {
    ...
    (0,_babel_runtime_corejs3_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3__.default)(this, "currentZoneName", void 0);
    ...
    for (var i = 0, l = zones.length; i < l; i += 1) {
      ...
      var targetEls = zoneType !== 'single' ? _babel_runtime_corejs3_core_js_array_from__WEBPACK_IMPORTED_MODULE_4___default()(_zone.children) : [_zone];
  ...
  (0,_babel_runtime_corejs3_helpers_createClass__WEBPACK_IMPORTED_MODULE_2__.default)(Rub, [{
    ...
    value: function output() {
      var _ref3 = this.region[this.currentZoneName],
    ...
    value: function input(ctime) {
      var _ref4 = this.region[this.currentZoneName],
          event = _ref4.event,
    ...
    value: function stopLoop() {
      var _ref5 = this.region[this.currentZoneName],
          recorder = _ref5.recorder;
      recorder.suspend();
    ...
    value: function getRecorder() {
      return this.region[this.currentZoneName].recorder;
    }
  }, {
    key: "setZone",
    ...
    value: function setEventHandler() {
      var _ref6 = this.region[this.currentZoneName],
          event = _ref6.event;
    ...
    value: function removeEventHandler() {
      var _ref7 = this.region[this.currentZoneName],
          event = _ref7.event;
    ...
    value: function resetZone() {
      var _ref8 = this.region[this.currentZoneName],
          event = _ref8.event,
          recorder = _ref8.recorder;
